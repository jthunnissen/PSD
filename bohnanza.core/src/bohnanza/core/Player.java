...
public abstract class Player {
	...
	public void trade(List<Card> receive, List<Card> give, boolean active) throws IllegalActionException {
		if(!isValidTrade(receive, give, active)) throw new IllegalActionException(this.getName() + " can only trade onwned for not owned cards");
		hand.removeAll(give);
	...
	public abstract JSONObject toJSON(List<Class<? extends Action>> list, HashMap<Integer, Card> cardIndex);
}
